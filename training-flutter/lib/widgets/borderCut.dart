...
class BorderCutWidget extends OutlineInputBorder {
  const BorderCutWidget({
  ...
  @override
  BorderCutWidget copyWith({
    BorderSide borderSide,
    BorderRadius borderRadius,
    double gapPadding,
    double cut,
  }) {
    return BorderCutWidget(
  ...
  ShapeBorder lerpFrom(ShapeBorder a, double t) {
    if (a is BorderCutWidget) {
      final BorderCutWidget outline = a;
  ...
  ShapeBorder lerpTo(ShapeBorder b, double t) {
    if (b is BorderCutWidget) {
      final BorderCutWidget outline = b;
